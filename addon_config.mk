...
meta:
	ADDON_NAME = ofxOpenCvContrib
	ADDON_DESCRIPTION = make use of opencv's contrib stuff
	ADDON_AUTHOR = @roymacdonald
	ADDON_TAGS = "addon" "opencv" "opencv-contrib"
	ADDON_URL = http://github.com/roymacdonald/ofxOpenCvContrib

common:
	# dependencies with other addons, a list of them separated by spaces 
	# or use += in several lines
	ADDON_DEPENDENCIES = ofxTbb
	...
	ADDON_DEFINES=USING_OFX_OPENCV_CONTRIB
